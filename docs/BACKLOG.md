...
- [ ] **A1 — Write-skew wow moment: RR corrupts, Serializable saves.**
...
- [ ] **A2 — Two-lane timeline that steps the engine.**
...
- [ ] **A3 — Per-transaction isolation selectors.**
...
- [ ] **A4 — Scenario picker for all three anomalies.**
...
- [ ] **A5 — Design polish: timeline is the hero.**
...
- [ ] **B1 — Shared table with live version chain.**
...
- [ ] **B2 — Anomaly flare + prevention moment.**
...
- [ ] **B4 — Plain-language explainer per step.**
...
- [ ] **B5 — Design polish: version chain + inspector.**
...
- [ ] **C1 — Synth SFX with persisted mute.**
...
- [ ] **C2 — Win/celebration for the wow moment.**
...
- [ ] **C4 — Landing page sharing the brand.**
